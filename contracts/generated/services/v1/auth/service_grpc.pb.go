...
const (
	AuthService_SignIn_FullMethodName  = "/services.v1.auth.AuthService/SignIn"
	AuthService_SignOut_FullMethodName = "/services.v1.auth.AuthService/SignOut"
	AuthService_Refresh_FullMethodName = "/services.v1.auth.AuthService/Refresh"
)
...
type AuthServiceClient interface {
	...
	Refresh(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*AuthResponse, error)
}
...
func (c *authServiceClient) Refresh(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*AuthResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthResponse)
...
type AuthServiceServer interface {
	...
	Refresh(context.Context, *emptypb.Empty) (*AuthResponse, error)
}
...
func (UnimplementedAuthServiceServer) Refresh(context.Context, *emptypb.Empty) (*AuthResponse, error) {
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "services.v1.auth.AuthService",
	...
	Metadata: "services/v1/auth/service.proto",
}
